...
def quickedit(Scenes,Requests,Files,secssync):
    ...
    for request in Requests:
        ...
        if presentation is "overlay":  
            ...
            #                               Slides (bg chromaed out and semi-transparent),
            #                               Bug (on right side scaled and scrolling down to show length of clip.)
            lower_third = (ImageClip(slidesname+str(startscene)+"_l3.png").set_pos(lambda t:(("center",(camera_video.h*0.95)-(lower_third.h)))).set_duration(camera_video.duration*0.45))
...
if not Files:
    ...
    print "Files are in the Array Skipping find Step"
